...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://kudouxiyiji.1412.com/", // 请替换为你的站点URL，以斜杠结尾
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/lantianzhiyue123",
					external: true,
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "本网址仅用于个人学习相关内容及学习情况的记录，无其他用途，特此说明。", // 公告内容
...
export const footerConfig: FooterConfig = {
	enable: true, // 启用页脚
	customHtml: "© 2026 端木燕", // 直接在这里设置你的页脚内容
